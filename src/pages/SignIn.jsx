  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data2.success) {
        ...
        // ✅ Instantly update Redux so Header re-renders
        dispatch(setUserDetails(data2.data));
        ...
        <div className="bg-sky-100 p-4 w-full max-w-xs mx-auto shadow-[0_-4px_6px_-1px,0_-2px_4px_-2px,0_4px_6px_-1px,0_2px_4px_-2px] rounded-lg shadow-gray-300">
          ...
          <form className="pt-10" onSubmit={handleSubmit}>
            ...
            <div className="grid mt-3">
              ...
              <Link
                to="/forgot-password"
                className="block ml-auto text-gray-700 hover:text-blue-600 hover:underline hover:scale-105"
              >
                Forgot Password?
              </Link>
            </div>
